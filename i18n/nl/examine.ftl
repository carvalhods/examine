...
build-id = Build-ID
image-id = Image-ID
image-version = Imageversie
vendor-name = Naam leverancier
ansi-color = ANSI-kleuren
logo = Logo
cpe-name = CPE-naam
home-url = Startpagina-URL
vendor-url = URL leverancier
doc-url = URL voor documentatie
